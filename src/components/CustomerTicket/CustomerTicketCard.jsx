...
const CustomerTicketCard = ({ tickets }) => {
  return (
    <div className='md:w-[80%] mx-auto'>
      ...
      <div className="py-10 grid gap-6 lg:grid-cols-2">
        ...
        {tickets.map(ticket=> <div className="bg-gray-100 rounded-lg shadow p-5">
          ...
          <div className="flex justify-between items-center mt-4 text-sm">
            <div className="flex gap-3">
              ...
              <span className="text-[#F83044] font-medium uppercase">{ticket.priority} priority</span>
            </div>
